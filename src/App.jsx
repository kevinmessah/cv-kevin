...
import { Mail, MapPin, ExternalLink, Award, Briefcase, GraduationCap, Sparkles, User, Share2, MoreHorizontal, ArrowRight, Layers } from 'lucide-react';
  ...
  return (
    <div className={`min-h-screen bg-black text-white font-sans selection:bg-purple-500 selection:text-white overflow-hidden relative transition-opacity duration-1000 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="relative z-10 max-w-md mx-auto h-full min-h-screen pb-12 flex flex-col">
        ...
        <div className="flex justify-between items-center px-6 pt-6 pb-2 text-xs font-medium text-white/70">
        ...
        <header className="px-6 pt-4 pb-8 flex flex-col items-center text-center">
          ...
          <h1 className="mt-5 text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60">
            Kevin Messah
          </h1>
          <p className="mt-2 text-sm text-purple-200 font-medium bg-purple-900/30 px-3 py-1 rounded-full border border-purple-500/30">
            {profile.role}
          </p>
        ...
        <div className="grid grid-cols-4 gap-4 px-6 mb-8">
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer"
            className="col-span-1 flex flex-col items-center gap-2 group cursor-pointer"
          >
            ...
            <span className="text-[10px] font-medium tracking-wide opacity-80">WhatsApp</span>
          </a>
          ...
          >
            ...
            <span className="text-[10px] font-medium tracking-wide opacity-80">Email</span>
          </a>

           {/* Share / More */}
           <div className="col-span-1 flex flex-col items-center gap-2 group cursor-pointer" onClick={() => {
                if (navigator.share) {
                    navigator.share({
                        title: 'Kevin Messah CV',
            ...
            <span className="text-[10px] font-medium tracking-wide opacity-80">Share</span>
          </div>

          {/* WHAT I CREATE MAIN BUTTON */}
           <a 
          ...
          >
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-500 to-purple-600 backdrop-blur-xl border border-white/20 flex items-center justify-center text-white transition-transform duration-300 hover:scale-110 shadow-lg shadow-purple-500/40 animate-pulse">
             ...
             <span className="text-[9px] font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400 tracking-wide text-center leading-3">WHAT I CREATE</span>
          </a>
        </div>
        ...
        <div className="space-y-6 px-4 flex-grow">
          ...
          <section className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-6 shadow-2xl">
            <h2 className="text-lg font-bold mb-3 flex items-center text-white/90">
          ...
          {/* EXPERIENCE */}
          <section className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-6 shadow-2xl">
            <h2 className="text-lg font-bold mb-4 flex items-center text-white/90">
            ...
            <div className="space-y-8 relative">
              ...
              <div className="pl-6 relative">
                 ...
                 <h3 className="font-semibold text-white text-sm">Freelance Multimedia Creative | Self-Employed</h3>
                 <span className="text-xs text-green-400 block mb-2">2022 – Sekarang</span>
                 <ul className="text-xs text-white/70 space-y-2 list-disc pl-3 marker:text-white/30 text-justify">
               ...
               {/* Job 2 */}
               <h3 className="text-xs font-bold text-white/40 uppercase tracking-widest mt-6 pl-6">PENGALAMAN ORGANISASI</h3>
               ...
               <div className="pl-6 relative mt-4">
                 ...
                 <h3 className="font-semibold text-white text-sm">Multimedia & Live Production Team</h3>
                 <span className="text-xs text-purple-400 block mb-2">2020 – Sekarang</span>
                 <ul className="text-xs text-white/70 space-y-2 list-disc pl-3 marker:text-white/30 text-justify">
              ...
              {/* Job 3 */}
               <div className="pl-6 relative">
                 <div className="absolute left-0 top-1.5 w-3.5 h-3.5 bg-purple-500 rounded-full border-4 border-black/50 box-content"></div>
                 <h3 className="font-semibold text-white text-sm">Staf Publikasi & Dokumentasi (Pubdok)</h3>
                 <ul className="text-xs text-white/70 space-y-2 list-disc pl-3 marker:text-white/30 mt-2 text-justify">
            ...
            <h2 className="text-lg font-bold mb-4 flex items-center text-white/90">
             ...
             <div className="space-y-4">
               <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                 <h3 className="text-sm font-semibold text-white">Institut Desain dan Bisnis Bali (IDB Bali)</h3>
                 <p className="text-xs text-pink-300 font-medium mt-1">S1 Desain Komunikasi Visual (DKV) | 2019 – 2022</p>
                 <ul className="mt-3 text-xs text-white/60 space-y-1 list-disc pl-3 marker:text-white/30 text-justify">
               ...
               <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                 <h3 className="text-sm font-semibold text-white">SMK Wira Harapan</h3>
                 <p className="text-xs text-pink-300 font-medium mt-1">Jurusan Multimedia | 2016 – 2019</p>
                 <ul className="mt-3 text-xs text-white/60 space-y-1 list-disc pl-3 marker:text-white/30 text-justify">
          ...
          <section className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-6 shadow-2xl mb-6">
            ...
            <ul className="grid grid-cols-2 gap-y-3 gap-x-4 text-xs text-white/80">
                <li className="flex items-start"><div className="w-1.5 h-1.5 bg-orange-400 rounded-full mr-2 mt-1.5 flex-shrink-0"></div>Desain Grafis</li>
                <li className="flex items-start"><div className="w-1.5 h-1.5 bg-orange-400 rounded-full mr-2 mt-1.5 flex-shrink-0"></div>Desain untuk media sosial</li>
                <li className="flex items-start"><div className="w-1.5 h-1.5 bg-orange-400 rounded-full mr-2 mt-1.5 flex-shrink-0"></div>Desain cetak</li>
                <li className="flex items-start"><div className="w-1.5 h-1.5 bg-orange-400 rounded-full mr-2 mt-1.5 flex-shrink-0"></div>Banner/poster/flyer</li>
                <li className="flex items-start"><div className="w-1.5 h-1.5 bg-orange-400 rounded-full mr-2 mt-1.5 flex-shrink-0"></div>Editing video</li>
                <li className="flex items-start"><div className="w-1.5 h-1.5 bg-orange-400 rounded-full mr-2 mt-1.5 flex-shrink-0"></div>Kemampuan memanfaatkan generative AI</li>
            </ul>
          </section>
          
           {/* SOFTWARE & TOOLS (MOVED BOTTOM) */}
          <section className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-6 shadow-2xl relative overflow-hidden mb-2">
             ...
             <div className="grid grid-cols-3 gap-4">
               ...
               <div className="flex flex-col items-center gap-2 p-3 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                  ...
                  <span className="text-[10px] text-white/70 text-center">Premiere Pro</span>
               </div>
               {/* CapCut */}
               <div className="flex flex-col items-center gap-2 p-3 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                  <SoftLogo type="capcut" />
                  <span className="text-[10px] text-white/70 text-center">CapCut</span>
               </div>
               {/* Photoshop */}
               <div className="flex flex-col items-center gap-2 p-3 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                  <SoftLogo type="photoshop" />
                  <span className="text-[10px] text-white/70 text-center">Photoshop</span>
               </div>
                {/* Canva */}
                <div className="flex flex-col items-center gap-2 p-3 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                  <SoftLogo type="canva" />
                  <span className="text-[10px] text-white/70 text-center">Canva</span>
               </div>
               {/* Audition */}
               <div className="flex flex-col items-center gap-2 p-3 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                  <SoftLogo type="audition" />
                  <span className="text-[10px] text-white/70 text-center">Audition</span>
               </div>
             </div>
          </section>
               ...
               <div className="relative bg-black/80 backdrop-blur-xl rounded-[22px] p-5 flex items-center justify-between">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-white/50">Explore my latest work</p>
                    </div>
                 </div>
                 <a 
                   href={profile.portfolioLink}
                   target="_blank" 
                   rel="noreferrer"
                   className="px-5 py-2 bg-white text-black font-bold rounded-full text-xs hover:scale-105 transition-transform shadow-lg shadow-white/20 flex items-center gap-1"
                 >
          ...
          <footer className="text-center pb-8 pt-4">
             <p className="text-[10px] text-white/30">© 2025 Kevin Messah. All Rights Reserved.</p>
